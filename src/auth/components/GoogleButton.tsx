...
/**
 * Google OAuth es un redirect de página completa (no popup ni SDK): el backend
 * maneja el consentimiento, setea las cookies y devuelve al FRONTEND_URL.
 * Por eso es un window.location y no un fetch.
 */
